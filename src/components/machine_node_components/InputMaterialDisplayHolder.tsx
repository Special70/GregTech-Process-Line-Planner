    ...
    return <>
        <div className="relative inline-flex group shadow-lg">
            <button className="w-17 h-17 bg-white border-2 nodrag" onClick={() => {
                ...
                submitDataDetails(props.nodeId, "input", props.ingredientData.id, props.ingredientData.name, props.ingredientData.img_filename, props.ingredientData.amount, props.ingredientData.consume_chance);
